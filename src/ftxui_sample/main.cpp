...
// configuration step. It creates a namespace called `clientlib`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", clientlib::cmake::project_name, clientlib::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", clientlib::cmake::project_version);
      return EXIT_SUCCESS;
    }
